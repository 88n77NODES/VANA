...
setup_url=". <(curl -s https://raw.githubusercontent.com/88n77NODES/VANA/main/setup.sh)" 
update_url=". <(curl -s https://raw.githubusercontent.com/88n77NODES/VANA/main/update.sh)" 
delete_url=". <(curl -s https://raw.githubusercontent.com/88n77NODES/VANA/main/delete.sh)" 
deploy_dlp_url=". <(curl -s https://raw.githubusercontent.com/88n77NODES/VANA/main/deploy.sh)" 
validator_setup_url=". <(curl -s https://raw.githubusercontent.com/88n77NODES/VANA/main/validator.sh)" 
